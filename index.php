...
.hero button span {
  ...
  text-shadow: 0px 3px 3px rgba(0, 0, 0, 0.2);
    ...
    <section id="feature" class="section-p1">
        <div class="fe-box">
            <img src="img/banner/bannermassa1.jpg" alt="" />
            <h6></h6>
        </div>
        <div class="fe-box">
            <img src="img/banner/bannermassa2.jpg" alt="" />
            <h6></h6>
        </div>
        <div class="fe-box">
            <img src="img/banner/bannermassa3.jpg" alt="" />
            <h6></h6>
        </div>
        <div class="fe-box">
            <img src="img/banner/bannermassa4.jpg" alt="" />
            <h6></h6>
        </div>
        </div>
    </section>
    ...
    <section id="page-header" class="about-header">
        <h2 id="texto_central"></h2>
        <a href="cadastrar.php" class="normal-link"><button class="normal">Superar meu medo</button></a>
    ...
    <section id="about-head" class="section-p1">
        <img src="img/banner/foto3.jpg" alt="" />
        <div>
            <h2>Sobre nós</h2>
            <p class="paragraph">
...
<footer class="section-p1">
    <div class="col">
        <img class="logo" src="img/banner/logofinal2.png" width="100px" alt="Drive Up" />
        <h4>Contato</h4>
        <p><strong>Endereço:</strong> Av. Cesário de Melo</p>
        <p><strong>E-mail:</strong> Suportedriveup@driveup.com.br</p>
        <p><strong>Horário:</strong> 9:00 - 17:00</p>
        <div class="social-icons">
            <a href="login.php"><i class="fab fa-facebook-f"></i></a>
            <a href="login.php"><i class="fab fa-instagram"></i></a>
            <a href="login.php"><i class="fab fa-twitter"></i></a>
            <a href="login.php"><i class="fab fa-linkedin-in"></i></a>
        </div>
    </div>
